...
alternates_F1 <- map(seq_len(testruns), function(x){
...
save(alternates_F1, file = "alternates_F1.rda")
...
df <- enframe(alternates_F1)
df <-  st_as_sf(do.call(rbind, alternates_F1))
...
# save robject
save(alternative, file = "rda_files/alternative.rda")
