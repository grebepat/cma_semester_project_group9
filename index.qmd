...
![Räubertochter](figures/raeubertochter_raw.png) ![Donner](figures/donner_raw.png)
...
ggplot(width_preference) +
  geom_bar(aes(x = width, y = perc, fill = type), stat = "identity", position = "dodge", width = 0.75, alpha = 0.5) +
  scale_fill_manual(values = c("#11E2A1","#9E1FA2")) +
  coord_flip() +
  theme_minimal() +
