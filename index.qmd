...
We further calculated mean slope and maximum slope per subsegment of 100m in each trajectory and created density plots for a better oversight @fig-slope_density. X-Axis show densities of subsegments while the Y-Axis show mean/max slope in 100m segments in %. No statistical method was applied regarding slope.

::: {#fig-slope_density layout-nrow="2"}
![mean positive slope per 100m subsegments](figures/mean_slope_up.png){.lightbox}

![max positive slope per 100m subsegments](figures/max_slope_up.png){.lightbox}
